...
<body>
  ...
  <section class="hero-section">
    ...
    <div class="hero-content">
      ...
      <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booking/index.php" class="hero-button">Book now!</a>
    </div>
  </section>
          ...
          <div class="col-md-6 col-lg-4 mb-4" id="baptism-card">
            <div class="service-card card h-100">
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary service-cta" data-toggle="modal" data-target="#loginModal">Book
                  Now</a>
              </div>
            </div>
          </div>

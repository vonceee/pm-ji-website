                ...
                <div class="card-body text-center">
                    ...
                    <div class="mt-2">
                        <small class="text-success">
                            <?= round(($summary['paid_amount'] ?? 0) / max($summary['total_revenue'] ?? 1, 1) * 100, 1) ?>% Collection Rate
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h4 class="text-warning mb-1">₱<?= number_format($summary['pending_amount'] ?? 0, 2) ?></h4>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="progress flex-grow-1 me-2" style="height: 8px;">
                                    <div class="progress-bar" style="width: <?= $event_data['revenue_percentage'] ?>%"></div>
                                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <h6 class="card-title mb-1"><?= htmlspecialchars($payment_data['payment_method']) ?></h6>
...
<div class="report-section">
                        ...
                        <td>
                            <div>
                                ...
                                <?php if (!empty($transaction['transaction_id'])): ?>
                                    <br>
                                    <small class="text-muted">ID: <?= htmlspecialchars($transaction['transaction_id']) ?></small>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
    ...
    <div class="mt-3">
        ...
        <button type="button" class="btn btn-success ml-2" onclick="exportTableToCSV('revenueTable', 'revenue-report.csv')">

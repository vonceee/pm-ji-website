...
<head>
    ...
    <title>PM&JI About Section</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" />
    <link rel="stylesheet" href="/NEW-PM-JI-RESERVIFY/public/components/about/about.css">
</head>
<body>
    <!-- About Section -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="about-section-title">
                        <h2>About PM&JI</h2>
                        <p>capturing life's most precious moments through the art of photography since 2019</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="about-content">
                        <div class="about-text">
                            ...
                            <p>
                                ...
                                PM&JI is dedicated to preserving memories in vivid detail, specializing in high-quality images for
                                a variety of events, including birthdays, weddings, anniversaries, baptisms, corporate
                        ...
                        <div class="about-image">
                            <div class="about-image-container">
                                <img src="/NEW-PM-JI-RESERVIFY/assets/bg/pmji.png" alt="PM&JI Photography Team" />
                            </div>
                        </div>
                    </div>
                </div>
